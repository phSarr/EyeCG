...
class _WebServices implements WebServices {
  ...
  @override
  Future<UserData> getUserStatusData(userID) async {
  ...
  @override
  Future<HttpResponse<dynamic>> deleteUserData(
    userID,
    token,
  ) async {
    const _extra = <String, dynamic>{};
  ...
  @override
  Future<UserData> editUserData(userID) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
